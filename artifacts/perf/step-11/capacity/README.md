...
- boundary: all seven slots contain local doc-captured backfill. `Capacity Tier` remains `evidence_collected_gate_blocked` until direct `capacity-dedicated` runs replace every backfilled artifact.
