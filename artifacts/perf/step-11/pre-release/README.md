...
- boundary: both `Pre-Release Tier` and `Capacity Tier` remain `evidence_collected_gate_blocked`; their populated slots contain local doc-captured backfill and are not sign-off evidence.
