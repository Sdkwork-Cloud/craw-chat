...
- Shared-gateway mode defaults Appbase, Drive, and Notary foundation upstreams to the shared
  `sdkwork-api-cloud-gateway` root. Direct dependency module URLs are explicit external upstream
