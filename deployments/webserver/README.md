...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `im-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `im-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `im-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `im.sdkwork.com` | 443 ssl + 80 |
