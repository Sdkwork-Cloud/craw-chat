...
pub fn render_prometheus() -> String {
    format!(
        "# HELP im_space_postgres_materialization_failures_total Supplemental postgres replay writes that failed\n\
         # TYPE im_space_postgres_materialization_failures_total counter\n\
         im_space_postgres_materialization_failures_total {}\n\
         # HELP im_space_postgres_atomic_write_failures_total Atomic journal and read-model transactions that rolled back\n\
         # TYPE im_space_postgres_atomic_write_failures_total counter\n\
         im_space_postgres_atomic_write_failures_total {}\n",
