...
from ..models import NotificationsListResponse, NotificationsRequestsCreateResponse201, NotificationsRetrieveResponse, RequestNotification
...
class NotificationsApi:
    ...
    def __init__(self, client: HttpClient):
        self._client = client
        self.requests = NotificationsRequestsApi(client)


    def list(self, page_size: Optional[int] = None, cursor: Optional[str] = None) -> NotificationsListResponse:
        """List notifications for the current principal"""
        query = build_query_string([
            {'name': 'page_size', 'value': page_size, 'style': 'form', 'explode': True, 'allow_reserved': False},
            {'name': 'cursor', 'value': cursor, 'style': 'form', 'explode': True, 'allow_reserved': False},
        ])
        return self._client.get(_append_query_string(f"/app/v3/api/notifications", query))

    def retrieve(self, notification_id: str) -> NotificationsRetrieveResponse:
...
class NotificationsRequestsApi:
    """notifications notifications.requests API client."""

    def __init__(self, client: HttpClient):
        self._client = client


    def create(self, body: RequestNotification) -> NotificationsRequestsCreateResponse201:
