...
class NotificationsApi(private val client: HttpClient) {
    ...
    suspend fun list(pageSize: Int? = null, cursor: String? = null): NotificationsListResponse? {
        val query = buildQueryString(listOf(
            QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            QueryParameterSpec("cursor", cursor, "form", true, false, null)
        ))
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/notifications"), query))
        return client.convertValue(raw, object : TypeReference<NotificationsListResponse>() {})
    }

    /** Request a notification task */
    suspend fun requestsCreate(body: RequestNotification): NotificationsRequestsCreateResponse201? {
        val raw = client.post(ApiPaths.appPath("/notifications/requests"), body, null, null, "application/json")
        return client.convertValue(raw, object : TypeReference<NotificationsRequestsCreateResponse201>() {})
    }

    /** Get a notification task */
    suspend fun retrieve(notificationId: String): NotificationsRetrieveResponse? {
        ...
        return client.convertValue(raw, object : TypeReference<NotificationsRetrieveResponse>() {})
    }
