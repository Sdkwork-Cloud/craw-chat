...
func NewNotificationsApi(client *sdkhttp.Client) *NotificationsApi {
    return &NotificationsApi{client: client}
}

// List notifications for the current principal
func (a *NotificationsApi) List(pageSize *int, cursor *string) (sdktypes.NotificationsListResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "page_size", Value: func() interface{} { if pageSize == nil { return nil }; return *pageSize }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "cursor", Value: func() interface{} { if cursor == nil { return nil }; return *cursor }(), Style: "form", Explode: true, AllowReserved: false},
    })
    raw, err := a.client.Get(AppendQueryString(AppApiPath("/notifications"), query), nil, nil)
    if err != nil {
        var zero sdktypes.NotificationsListResponse
        return zero, err
    }
    return decodeResult[sdktypes.NotificationsListResponse](raw)
}

// Request a notification task
func (a *NotificationsApi) RequestsCreate(body sdktypes.RequestNotification) (sdktypes.NotificationsRequestsCreateResponse201, error) {
    raw, err := a.client.Post(AppApiPath("/notifications/requests"), body, nil, nil, "application/json")
    if err != nil {
        var zero sdktypes.NotificationsRequestsCreateResponse201
        return zero, err
    }
    return decodeResult[sdktypes.NotificationsRequestsCreateResponse201](raw)
}

// Get a notification task
func (a *NotificationsApi) Retrieve(notificationId string) (sdktypes.NotificationsRetrieveResponse, error) {
    ...
    if err != nil {
        var zero sdktypes.NotificationsRetrieveResponse
        return zero, err
    }
    return decodeResult[sdktypes.NotificationsRetrieveResponse](raw)
}
