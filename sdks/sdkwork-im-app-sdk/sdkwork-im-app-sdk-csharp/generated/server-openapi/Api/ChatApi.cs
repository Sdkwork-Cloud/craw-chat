...
namespace Sdkwork.Im.AppApi.Generated.Api
{
    public class ChatApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseRetrieveResponse?> ConversationsKnowledgebaseRetrieveAsync(string conversationId)
        {
            return await _client.GetAsync<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseRetrieveResponse>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/knowledgebase"));
        }

        /// <summary>
        /// Lazily create the group knowledgebase
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseCreateResponse?> ConversationsKnowledgebaseCreateAsync(string conversationId, Sdkwork.Im.AppApi.Generated.Models.CreateGroupKnowledgebaseRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseCreateResponse>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/knowledgebase"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Issue a one-time group knowledgebase launch ticket
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseLaunchResponse?> ConversationsKnowledgebaseLaunchAsync(string conversationId, Sdkwork.Im.AppApi.Generated.Models.LaunchGroupKnowledgebaseRequest body, string idempotencyKey)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.Im.AppApi.Generated.Models.ConversationsKnowledgebaseLaunchResponse>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/knowledgebase/launch"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Archive a group conversation and schedule its knowledgebase archive
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.ConversationsArchiveResponse?> ConversationsArchiveAsync(string conversationId, Sdkwork.Im.AppApi.Generated.Models.ArchiveGroupConversationRequest body, string idempotencyKey)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PostAsync<Sdkwork.Im.AppApi.Generated.Models.ConversationsArchiveResponse>(ApiPaths.AppPath($"/chat/conversations/{SerializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false))}/archive"), body, null, requestHeaders, "application/json");
        }
