...
namespace Sdkwork.Im.AppApi.Generated.Api
{
    public class NotificationsApi
    {
        ...
        public NotificationsApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.NotificationsListResponse?> ListAsync(int? pageSize = null, string? cursor = null)
        {
            ...
            return await _client.GetAsync<Sdkwork.Im.AppApi.Generated.Models.NotificationsListResponse>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/notifications"), queryString));
        }

        /// <summary>
        /// Request a notification task
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.NotificationsRequestsCreateResponse201?> RequestsCreateAsync(Sdkwork.Im.AppApi.Generated.Models.RequestNotification body)
        {
            return await _client.PostAsync<Sdkwork.Im.AppApi.Generated.Models.NotificationsRequestsCreateResponse201>(ApiPaths.AppPath("/notifications/requests"), body, null, null, "application/json");
        }

        /// <summary>
        /// Get a notification task
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.NotificationsRetrieveResponse?> RetrieveAsync(string notificationId)
        {
            return await _client.GetAsync<Sdkwork.Im.AppApi.Generated.Models.NotificationsRetrieveResponse>(ApiPaths.AppPath($"/notifications/{SerializePathParameter(notificationId, new PathParameterSpec("notificationId", "simple", false))}"));
        }
