...
namespace Sdkwork.Im.AppApi.Generated.Api
{
    public class NotificationsApi
    {
        ...
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.NotificationsListResponse?> ListAsync()
        {
            return await _client.GetAsync<Sdkwork.Im.AppApi.Generated.Models.NotificationsListResponse>(ApiPaths.AppPath("/notifications"));
        }

        /// <summary>
        /// Request a notification task
        /// </summary>
        public async Task<Sdkwork.Im.AppApi.Generated.Models.NotificationsRequestsCreateResponse?> RequestsCreateAsync(Sdkwork.Im.AppApi.Generated.Models.RequestNotification body)
        {
            return await _client.PostAsync<Sdkwork.Im.AppApi.Generated.Models.NotificationsRequestsCreateResponse>(ApiPaths.AppPath("/notifications/requests"), body, null, null, "application/json");
        }
