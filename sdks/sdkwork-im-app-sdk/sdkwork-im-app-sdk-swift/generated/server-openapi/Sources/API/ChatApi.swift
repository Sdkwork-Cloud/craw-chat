...
public class ChatApi {
    ...
    public func conversationsKnowledgebaseRetrieve(conversationId: String) async throws -> ConversationsKnowledgebaseRetrieveResponse? {
        return try await client.get(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/knowledgebase"), responseType: ConversationsKnowledgebaseRetrieveResponse.self)
    }

    /// Lazily create the group knowledgebase
    public func conversationsKnowledgebaseCreate(conversationId: String, body: CreateGroupKnowledgebaseRequest, idempotencyKey: String) async throws -> ConversationsKnowledgebaseCreateResponse? {
        ...
        return try await client.post(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/knowledgebase"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ConversationsKnowledgebaseCreateResponse.self)
    }

    /// Issue a one-time group knowledgebase launch ticket
    public func conversationsKnowledgebaseLaunch(conversationId: String, body: LaunchGroupKnowledgebaseRequest, idempotencyKey: String) async throws -> ConversationsKnowledgebaseLaunchResponse? {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
        ...
        return try await client.post(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/knowledgebase/launch"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ConversationsKnowledgebaseLaunchResponse.self)
    }

    /// Archive a group conversation and schedule its knowledgebase archive
    public func conversationsArchive(conversationId: String, body: ArchiveGroupConversationRequest, idempotencyKey: String) async throws -> ConversationsArchiveResponse? {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
        ...
        return try await client.post(ApiPaths.appPath("/chat/conversations/\(serializePathParameter(conversationId, PathParameterSpec(name: "conversationId", style: "simple", explode: false)))/archive"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ConversationsArchiveResponse.self)
    }
