...
public class NotificationsApi {
    ...
    public func list() async throws -> NotificationsListResponse? {
        return try await client.get(ApiPaths.appPath("/notifications"), responseType: NotificationsListResponse.self)
    }

    /// Request a notification task
    public func requestsCreate(body: RequestNotification) async throws -> NotificationsRequestsCreateResponse? {
        return try await client.post(ApiPaths.appPath("/notifications/requests"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: NotificationsRequestsCreateResponse.self)
    }
