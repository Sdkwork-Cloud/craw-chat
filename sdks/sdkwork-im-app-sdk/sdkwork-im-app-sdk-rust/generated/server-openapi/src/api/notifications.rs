...
use crate::models::{NotificationsListResponse, NotificationsRequestsCreateResponse, NotificationsRetrieveResponse, RequestNotification};
...
impl NotificationsApi {
    ...
    pub async fn list(&self) -> Result<NotificationsListResponse, SdkworkError> {
        let path = app_path(&"/notifications".to_string());
        self.client.get(&path, None, None).await
    }

    /// Request a notification task
    pub async fn requests_create(&self, body: &RequestNotification) -> Result<NotificationsRequestsCreateResponse, SdkworkError> {
