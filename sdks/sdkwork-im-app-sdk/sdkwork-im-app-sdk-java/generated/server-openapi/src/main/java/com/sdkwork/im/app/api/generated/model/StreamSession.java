...
public class StreamSession {
    ...
    private String lastFrameSeq;
    private String lastCheckpointSeq;
    ...
    public String getLastFrameSeq() {
        return this.lastFrameSeq;
    }

    public void setLastFrameSeq(String lastFrameSeq) {
        this.lastFrameSeq = lastFrameSeq;
    }

    public String getLastCheckpointSeq() {
        return this.lastCheckpointSeq;
    }

    public void setLastCheckpointSeq(String lastCheckpointSeq) {
