...
public class ChatApi {
    ...
    public ConversationsKnowledgebaseRetrieveResponse conversationsKnowledgebaseRetrieve(String conversationId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/chat/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false)) + "/knowledgebase"));
        return client.convertValue(raw, new TypeReference<ConversationsKnowledgebaseRetrieveResponse>() {});
    }

    /** Lazily create the group knowledgebase */
    public ConversationsKnowledgebaseCreateResponse conversationsKnowledgebaseCreate(String conversationId, CreateGroupKnowledgebaseRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.appPath("/chat/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false)) + "/knowledgebase"), body, null, requestHeaders, "application/json");
        return client.convertValue(raw, new TypeReference<ConversationsKnowledgebaseCreateResponse>() {});
    }

    /** Issue a one-time group knowledgebase launch ticket */
    public ConversationsKnowledgebaseLaunchResponse conversationsKnowledgebaseLaunch(String conversationId, LaunchGroupKnowledgebaseRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.appPath("/chat/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false)) + "/knowledgebase/launch"), body, null, requestHeaders, "application/json");
        return client.convertValue(raw, new TypeReference<ConversationsKnowledgebaseLaunchResponse>() {});
    }

    /** Archive a group conversation and schedule its knowledgebase archive */
    public ConversationsArchiveResponse conversationsArchive(String conversationId, ArchiveGroupConversationRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.appPath("/chat/conversations/" + serializePathParameter(conversationId, new PathParameterSpec("conversationId", "simple", false)) + "/archive"), body, null, requestHeaders, "application/json");
        return client.convertValue(raw, new TypeReference<ConversationsArchiveResponse>() {});
    }
