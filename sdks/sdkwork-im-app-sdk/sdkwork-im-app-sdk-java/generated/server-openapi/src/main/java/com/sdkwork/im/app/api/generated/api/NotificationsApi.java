...
public class NotificationsApi {
    ...
    public NotificationsApi(HttpClient client) {
        this.client = client;
    }

    /** List notifications for the current principal */
    public NotificationsListResponse list(Integer pageSize, String cursor) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("page_size", pageSize, "form", true, false, null),
            new QueryParameterSpec("cursor", cursor, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/notifications"), query));
        return client.convertValue(raw, new TypeReference<NotificationsListResponse>() {});
    }

    /** Request a notification task */
    public NotificationsRequestsCreateResponse201 requestsCreate(RequestNotification body) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/notifications/requests"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<NotificationsRequestsCreateResponse201>() {});
    }

    /** Get a notification task */
    public NotificationsRetrieveResponse retrieve(String notificationId) throws Exception {
        ...
        return client.convertValue(raw, new TypeReference<NotificationsRetrieveResponse>() {});
    }
