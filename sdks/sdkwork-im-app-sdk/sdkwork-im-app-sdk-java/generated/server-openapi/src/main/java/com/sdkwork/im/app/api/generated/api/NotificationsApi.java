...
public class NotificationsApi {
    ...
    public NotificationsListResponse list() throws Exception {
    ...
    public NotificationsRequestsCreateResponse requestsCreate(RequestNotification body) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/notifications/requests"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<NotificationsRequestsCreateResponse>() {});
    }
