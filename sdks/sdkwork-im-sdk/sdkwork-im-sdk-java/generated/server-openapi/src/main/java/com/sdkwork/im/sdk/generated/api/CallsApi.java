...
public class CallsApi {
    ...
    public CallsSessionsSignalsListResponse sessionsSignalsList(String rtcSessionId, Integer afterSignalSeq, String cursor, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.imPath("/calls/sessions/" + serializePathParameter(rtcSessionId, new PathParameterSpec("rtcSessionId", "simple", false)) + "/signals"), query));
        return client.convertValue(raw, new TypeReference<CallsSessionsSignalsListResponse>() {});
    }
    ...
    public CallsSessionsCredentialsRefreshResponse sessionsCredentialsRefresh(String rtcSessionId, IssueRtcParticipantCredentialRequest body) throws Exception {
        Object raw = client.post(ApiPaths.imPath("/calls/sessions/" + serializePathParameter(rtcSessionId, new PathParameterSpec("rtcSessionId", "simple", false)) + "/credentials/refresh"), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<CallsSessionsCredentialsRefreshResponse>() {});
    }
