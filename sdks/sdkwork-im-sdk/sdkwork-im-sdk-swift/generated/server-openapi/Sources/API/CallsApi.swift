...
public class CallsApi {
    ...
    public func sessionsSignalsList(rtcSessionId: String, afterSignalSeq: Int? = nil, cursor: String? = nil, pageSize: Int? = nil) async throws -> CallsSessionsSignalsListResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.imPath("/calls/sessions/\(serializePathParameter(rtcSessionId, PathParameterSpec(name: "rtcSessionId", style: "simple", explode: false)))/signals"), query), responseType: CallsSessionsSignalsListResponse.self)
    }
    ...
    public func sessionsCredentialsRefresh(rtcSessionId: String, body: IssueRtcParticipantCredentialRequest) async throws -> CallsSessionsCredentialsRefreshResponse? {
        return try await client.post(ApiPaths.imPath("/calls/sessions/\(serializePathParameter(rtcSessionId, PathParameterSpec(name: "rtcSessionId", style: "simple", explode: false)))/credentials/refresh"), body: body, params: nil, headers: nil, contentType: "application/json", responseType: CallsSessionsCredentialsRefreshResponse.self)
    }
